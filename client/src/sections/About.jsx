      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        <div className="flex items-end grid-default-color grid-1">
          ...
          <div className="z-10">
            ...
            <p className="subtext">
              ...
              responsive software and web applications.
            </p>
          </div>
        ...
        <div className="grid-default-color grid-5">
            <div className="z-10 w-[50%]">
                ...
                <p className="subtext"> I do a varity of languages, frameworks and tools that allow me to build robust and scalable applications </p>
            </div>
